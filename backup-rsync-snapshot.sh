...
CLEF=~/.ssh/id_rsa_backup-gobt                       # backup key to use
VOL=houyo                                            # destination volume (name given by admin sys)
EXCLUDE_FILE="/home/nomad/bin/exclude-backup-laptop" # file with list of exluded files
BACKUP_FOLDER=/media/gobt/Backup-houyo               # can be empty - autofs needed
...
# Backup-houyo	 -fstype=nfs,ro,intr    192.168.0.7:/snob/backup/laptop/houyo # need to be adjust
